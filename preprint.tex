...
\begin{table}[H]
    ...
    \begin{tabular}{lll}
        ...
        \midrule
        Curitiba, PR & \texttt{BRA\_PR\_Curitiba-Pena.Intl.AP.838400\_TMYx.epw} & \text{1961-2017} \\
        Rio de Janeiro, RJ & \texttt{BRA\_RJ\_Rio.de.Janeiro-Santos.Dumont.AP.837550\_TMYx.epw} & \text{1973-2017}\\
        \bottomrule
    \end{tabular}
